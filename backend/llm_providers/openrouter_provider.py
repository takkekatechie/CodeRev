"""
OpenRouter Provider - Unified access to multiple LLM models
"""
...
class OpenRouterProvider(BaseLLMProvider):
    ...
    def check_availability(self) -> bool:
        ...
        try:
            ...
            headers = {
                ...
                "HTTP-Referer": "https://github.com/codereviewpro",
                "X-Title": "CodeReviewPro"
            }
    ...
    def analyze_code(self, file_path: str, content: str, language: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            import logging
            logging.error(f"OpenRouter analysis error: {e}")
            return []
